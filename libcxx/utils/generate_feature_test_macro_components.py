...
feature_test_macros = sorted([ add_version_header(x) for x in [
  ...
  {"name": "__cpp_lib_shared_timed_mutex",
   ...
   "depends": "!defined(_LIBCUDAFORDALICXX_HAS_NO_THREADS)",
   "internal_depends": "!defined(_LIBCUDAFORDALICXX_HAS_NO_THREADS)",
  },
  # C++17 macros
  ...
  {"name": "__cpp_lib_addressof_constexpr",
   ...
   "internal_depends": "defined(_LIBCUDAFORDALICXX_ADDRESSOF)",
   },
  ...
  {"name": "__cpp_lib_has_unique_object_representations",
   ...
   "internal_depends": "defined(_LIBCUDAFORDALICXX_HAS_UNIQUE_OBJECT_REPRESENTATIONS)",
   },
  {"name": "__cpp_lib_is_aggregate",
   ...
   "internal_depends": "!defined(_LIBCUDAFORDALICXX_HAS_NO_IS_AGGREGATE)",
   },
  ...
  {"name": "__cpp_lib_char8_t",
   ...
   "internal_depends": "!defined(_LIBCUDAFORDALICXX_NO_HAS_CHAR8_T)",
   },
  ...
  {"name": "__cpp_lib_is_constant_evaluated",
   ...
   "internal_depends": "defined(_LIBCUDAFORDALICXX_IS_CONSTANT_EVALUATED)",
   },
...
#ifndef _LIBCUDAFORDALICXX_VERSIONH
#define _LIBCUDAFORDALICXX_VERSIONH
...
#if _LIBCUDAFORDALICXX_STD_VER > 17
{cxx2a_macros}
#endif

#endif // _LIBCUDAFORDALICXX_VERSIONH
"""
...
#     error "{name} should have the value {value} in {std}"
#   endif
# else // _LIBCUDAFORDALICXX_VERSION
#   ifdef {name}
