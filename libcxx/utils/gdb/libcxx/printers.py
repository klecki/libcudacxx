...
These should work for objects compiled when _LIBCUDAFORDALICXX_ABI_UNSTABLE is defined
...
class StdStringPrinter(object):
    ...
    def _get_short_size(self, short_field, short_size):
        ...
        # was compiled with _LIBCUDAFORDALICXX_ABI_ALTERNATE_STRING_LAYOUT defined.
