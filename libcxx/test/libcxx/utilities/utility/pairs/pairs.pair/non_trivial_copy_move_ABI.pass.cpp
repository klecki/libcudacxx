...
#undef _LIBCUDAFORDALICXX_ABI_UNSTABLE
#undef _LIBCUDAFORDALICXX_ABI_VERSION
#define _LIBCUDAFORDALICXX_ABI_VERSION 1
#define _LIBCUDAFORDALICXX_DEPRECATED_ABI_DISABLE_PAIR_TRIVIAL_COPY_CTOR
