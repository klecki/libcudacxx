...
_LIBCUDAFORDALICXX_SAFE_STATIC std::unique_ptr<int> global_static_unique_ptr_single;
_LIBCUDAFORDALICXX_SAFE_STATIC std::unique_ptr<int[]> global_static_unique_ptr_runtime;
#endif
