...
#if defined(_LIBCUDAFORDALICXX_VERSION) && TEST_STD_VER >= 11
_LIBCUDAFORDALICXX_SAFE_STATIC std::unique_ptr<int> global_static_unique_ptr_single(nullptr);
_LIBCUDAFORDALICXX_SAFE_STATIC std::unique_ptr<int[]> global_static_unique_ptr_runtime(nullptr);
#endif
