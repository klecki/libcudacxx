...
directory_iterator& directory_iterator::__increment(error_code* ec) {
  _LIBCUDAFORDALICXX_ASSERT(__imp_, "Attempting to increment an invalid iterator");
...
directory_entry const& directory_iterator::__dereference() const {
  _LIBCUDAFORDALICXX_ASSERT(__imp_, "Attempting to dereference an invalid iterator");
...
void recursive_directory_iterator::__pop(error_code* ec) {
  _LIBCUDAFORDALICXX_ASSERT(__imp_, "Popping the end iterator");
  if (ec)
    ec->clear();
  __imp_->__stack_.pop();
