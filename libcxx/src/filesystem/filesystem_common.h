...
#define _LIBCUDAFORDALICXX_USE_UTIMENSAT
#endif
#endif
...
static string format_string_imp(const char* msg, ...) {
  ...
  _LIBCUDAFORDALICXX_ASSERT(static_cast<size_t>(ret) == (size_with_null - 1), "TODO");
...
error_code capture_errno() {
  _LIBCUDAFORDALICXX_ASSERT(errno, "Expected errno to be non-zero");
...
T error_value();
template <>
_LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 void error_value<void>() {}
template <>
...
template <>
_LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 file_time_type error_value<file_time_type>() {
...
private:
#if _LIBCUDAFORDALICXX_STD_VER > 11 && !defined(_LIBCUDAFORDALICXX_HAS_NO_CXX14_CONSTEXPR)
...
public:
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 bool checked_set(CType* out,
                                                        ChronoType time) {
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 bool is_representable(TimeSpecT tm) {
    if (tm.tv_sec >= 0) {
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 bool is_representable(FileTimeT tm) {
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 FileTimeT
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 bool
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR_AFTER_CXX11 bool convert_to_timespec(TimeSpecT& dest,
                                                                FileTimeT tp) {
