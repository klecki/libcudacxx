...
#if _LIBCUDAFORDALICXX_ABI_VERSION == 1
template _LIBCUDAFORDALICXX_FUNC_VIS valarray<size_t>::valarray(size_t);
template _LIBCUDAFORDALICXX_FUNC_VIS valarray<size_t>::~valarray();
#endif
