...
template class _LIBCUDAFORDALICXX_CLASS_TEMPLATE_INSTANTIATION_VIS __basic_string_common<true>;

template class _LIBCUDAFORDALICXX_CLASS_TEMPLATE_INSTANTIATION_VIS basic_string<char>;
template class _LIBCUDAFORDALICXX_CLASS_TEMPLATE_INSTANTIATION_VIS basic_string<wchar_t>;
...
get_swprintf()
{
#ifndef _LIBCUDAFORDALICXX_MSVCRT
    return swprintf;
#else
...
//  so we need +1 here.
    ...
    _LIBCUDAFORDALICXX_ASSERT(res.ec == errc(), "bufsize must be large enough to accomodate the value");
