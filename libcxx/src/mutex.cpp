...
mutex::unlock() _NOEXCEPT
{
    ...
    (void)ec;
    _LIBCUDAFORDALICXX_ASSERT(ec == 0, "call to mutex::unlock failed");
}
...
recursive_mutex::~recursive_mutex()
{
    ...
    (void)e;
    _LIBCUDAFORDALICXX_ASSERT(e == 0, "call to ~recursive_mutex() failed");
}
...
recursive_mutex::unlock() _NOEXCEPT
{
    ...
    (void)e;
    _LIBCUDAFORDALICXX_ASSERT(e == 0, "call to recursive_mutex::unlock() failed");
}
...
#ifndef _LIBCUDAFORDALICXX_HAS_NO_THREADS
_LIBCUDAFORDALICXX_SAFE_STATIC static __libcpp_mutex_t mut = _LIBCUDAFORDALICXX_MUTEX_INITIALIZER;
_LIBCUDAFORDALICXX_SAFE_STATIC static __libcpp_condvar_t cv = _LIBCUDAFORDALICXX_CONDVAR_INITIALIZER;
#endif
...
#else // !_LIBCUDAFORDALICXX_HAS_NO_THREADS
