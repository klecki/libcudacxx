...
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrCreate(void*);
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrDestroy(void*);
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrCopy(void*, const void*);
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrAssign(void*, const void*);
_LIBCUDAFORDALICXX_CRT_FUNC bool __cdecl __ExceptionPtrCompare(const void*, const void*);
_LIBCUDAFORDALICXX_CRT_FUNC bool __cdecl __ExceptionPtrToBool(const void*);
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrSwap(void*, void*);
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrCurrentException(void*);
[[noreturn]] _LIBCUDAFORDALICXX_CRT_FUNC void __cdecl __ExceptionPtrRethrow(const void*);
_LIBCUDAFORDALICXX_CRT_FUNC void __cdecl
