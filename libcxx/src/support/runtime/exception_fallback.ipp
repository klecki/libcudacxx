...
_LIBCUDAFORDALICXX_SAFE_STATIC static std::terminate_handler  __terminate_handler;
_LIBCUDAFORDALICXX_SAFE_STATIC static std::unexpected_handler __unexpected_handler;
