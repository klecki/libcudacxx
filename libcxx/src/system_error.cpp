...
handle_strerror_r_return(int strerror_return, char *buffer) {
  ...
  _LIBCUDAFORDALICXX_ASSERT(new_errno == ERANGE, "unexpected error from ::strerror_r");
...
class _LIBCUDAFORDALICXX_HIDDEN __generic_error_category
    : public __do_message
{
public:
...
__generic_error_category::message(int ev) const
{
    ...
    if (ev > _LIBCUDAFORDALICXX_ELAST)
...
class _LIBCUDAFORDALICXX_HIDDEN __system_error_category
    : public __do_message
{
public:
    virtual const char* name() const _NOEXCEPT;
