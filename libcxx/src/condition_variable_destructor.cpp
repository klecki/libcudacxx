...
# if _LIBCUDAFORDALICXX_ABI_VERSION == 1 || !defined(_LIBCUDAFORDALICXX_HAS_TRIVIAL_CONDVAR_DESTRUCTION)
...
class _LIBCUDAFORDALICXX_TYPE_VIS condition_variable
{
    __libcpp_condvar_t __cv_ = _LIBCUDAFORDALICXX_CONDVAR_INITIALIZER;
public:
