...
#   define _LIBCUDAFORDALICXX_HAS_ATOMIC_BUILTINS
#elif !defined(__clang__) && defined(_GNUC_VER) && _GNUC_VER >= 407
#   define _LIBCUDAFORDALICXX_HAS_ATOMIC_BUILTINS
#endif

#if !defined(_LIBCUDAFORDALICXX_HAS_ATOMIC_BUILTINS) && !defined(_LIBCUDAFORDALICXX_HAS_NO_THREADS)
# if defined(_LIBCUDAFORDALICXX_WARNING)
    _LIBCUDAFORDALICXX_WARNING("Building libc++ without __atomic builtins is unsupported")
# else
