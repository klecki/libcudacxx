...
#if defined(_LIBCUDAFORDALICXX_USING_WIN32_RANDOM)
// Must be defined before including stdlib.h to enable rand_s().
#define _CRT_RAND_S
#endif // defined(_LIBCUDAFORDALICXX_USING_WIN32_RANDOM)
...
#if defined(_LIBCUDAFORDALICXX_USING_GETENTROPY)
#include <sys/random.h>
#elif defined(_LIBCUDAFORDALICXX_USING_DEV_RANDOM)
#include <fcntl.h>
#include <unistd.h>
#elif defined(_LIBCUDAFORDALICXX_USING_NACL_RANDOM)
...
#elif defined(_LIBCUDAFORDALICXX_USING_ARC4_RANDOM)
...
#elif defined(_LIBCUDAFORDALICXX_USING_WIN32_RANDOM)
