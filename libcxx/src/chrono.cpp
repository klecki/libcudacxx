...
#endif // defined(_LIBCUDAFORDALICXX_WIN32API)

#if !defined(_LIBCUDAFORDALICXX_HAS_NO_MONOTONIC_CLOCK)
#if __APPLE__
#include <mach/mach_time.h>  // mach_absolute_time, mach_timebase_info_data_t
#elif !defined(_LIBCUDAFORDALICXX_WIN32API) && !defined(CLOCK_MONOTONIC)
...
system_clock::now() _NOEXCEPT
{
  ...
  static _LIBCUDAFORDALICXX_CONSTEXPR const seconds nt_to_unix_epoch{11644473600};
...
#ifndef _LIBCUDAFORDALICXX_HAS_NO_MONOTONIC_CLOCK
// steady_clock
//
...
#if defined(_LIBCUDAFORDALICXX_USE_CLOCK_GETTIME) && defined(CLOCK_UPTIME_RAW)
...
#endif // defined(_LIBCUDAFORDALICXX_USE_CLOCK_GETTIME) && defined(CLOCK_UPTIME_RAW)

#elif defined(_LIBCUDAFORDALICXX_WIN32API)
...
#endif // !_LIBCUDAFORDALICXX_HAS_NO_MONOTONIC_CLOCK
