...
template<class _Type, class _Scope, typename _CUDA_FOR_DALI_VSTD::enable_if<sizeof(_Type) <= 2, int>::type = 0>
...
template<class _Type, class _Delta, class _Scope, typename _CUDA_FOR_DALI_VSTD::enable_if<sizeof(_Type)<=2, int>::type = 0>
