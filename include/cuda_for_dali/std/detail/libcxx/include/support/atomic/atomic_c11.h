...
struct __cxx_atomic_base_impl {
  ...
  _LIBCUDAFORDALICXX_CONSTEXPR explicit __cxx_atomic_base_impl(_Tp value) _NOEXCEPT
    : __a_value(value) {}
  _LIBCUDAFORDALICXX_DISABLE_EXTENSION_WARNING _Atomic(_Tp) __a_value;
};

#define __cxx_atomic_is_lock_free(__s) __c11_atomic_is_lock_free(__s)

_LIBCUDAFORDALICXX_INLINE_VISIBILITY inline
