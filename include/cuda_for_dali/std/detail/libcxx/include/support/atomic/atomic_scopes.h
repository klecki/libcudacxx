#ifndef __LIBCUDAFORDALICXX_ATOMIC_SCOPES_H
#define __LIBCUDAFORDALICXX_ATOMIC_SCOPES_H
...
#define _LIBCUDAFORDALICXX_ATOMIC_SCOPE_TYPE ::cuda_for_dali::thread_scope
#define _LIBCUDAFORDALICXX_ATOMIC_SCOPE_DEFAULT ::cuda_for_dali::thread_scope::system
...
template <int _Scope>
_LIBCUDAFORDALICXX_INLINE_VISIBILITY auto constexpr __scope_tag() ->
        typename __scope_enum_to_tag<_Scope>::type {
    return typename __scope_enum_to_tag<_Scope>::type();
}

#endif // __LIBCUDAFORDALICXX_ATOMIC_SCOPES_H
