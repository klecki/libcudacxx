...
template<class _Type, typename cuda_for_dali::std::enable_if<sizeof(_Type)==4, int>::type = 0>
...
template<class _Type, typename cuda_for_dali::std::enable_if<sizeof(_Type)==8, int>::type = 0>
__device__ void __atomic_store_cuda(volatile _Type *__ptr, _Type *__val, int __memorder, __thread_scope_block_tag) {
    uint64_t __tmp = 0;
