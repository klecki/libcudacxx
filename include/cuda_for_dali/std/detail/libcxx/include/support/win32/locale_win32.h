...
#ifndef _LIBCUDAFORDALICXX_SUPPORT_WIN32_LOCALE_WIN32_H
#define _LIBCUDAFORDALICXX_SUPPORT_WIN32_LOCALE_WIN32_H
...
_LIBCUDAFORDALICXX_FUNC_VIS int snprintf_l(char *ret, size_t n, locale_t loc, const char *format, ...);
_LIBCUDAFORDALICXX_FUNC_VIS int asprintf_l( char **ret, locale_t loc, const char *format, ... );
_LIBCUDAFORDALICXX_FUNC_VIS int vasprintf_l( char **ret, locale_t loc, const char *format, va_list ap );
...
#endif // _LIBCUDAFORDALICXX_SUPPORT_WIN32_LOCALE_WIN32_H
