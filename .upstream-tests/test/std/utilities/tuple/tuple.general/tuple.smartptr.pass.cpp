...
// cuda_for_dali::std::___ptr not supported
//#include <memory>
...
int main(int, char**) {
  ...
  /*
    {
    cuda_for_dali::std::tuple<cuda_for_dali::std::unique_ptr<char>> up;
    cuda_for_dali::std::tuple<cuda_for_dali::std::shared_ptr<char>> sp;
    cuda_for_dali::std::tuple<cuda_for_dali::std::weak_ptr  <char>> wp;
    }
    {
    cuda_for_dali::std::tuple<cuda_for_dali::std::unique_ptr<char[]>> up;
    cuda_for_dali::std::tuple<cuda_for_dali::std::shared_ptr<char[]>> sp;
