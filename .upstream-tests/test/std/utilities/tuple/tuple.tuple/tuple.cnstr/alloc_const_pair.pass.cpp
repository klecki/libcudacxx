...
{
    {
        typedef cuda_for_dali::std::pair<long, int> T0;
        typedef cuda_for_dali::std::tuple<long long, double> T1;
        T0 t0(2, 3);
    ...
    {
        typedef cuda_for_dali::std::pair<int, int> T0;
        typedef cuda_for_dali::std::tuple<alloc_first, double> T1;
        T0 t0(2, 3);
