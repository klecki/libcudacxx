...
__host__ __device__ void test_sfinae() {
    using Tup = cuda_for_dali::std::tuple<Elem>;
    // cuda_for_dali::std::allocator not supported
    // using Alloc = cuda_for_dali::std::allocator<void>;
    // using Tag = cuda_for_dali::std::allocator_arg_t;
    // special members
    {
        static_assert(cuda_for_dali::std::is_default_constructible<Tup>::value, "");
        static_assert(cuda_for_dali::std::is_move_constructible<Tup>::value, "");
        static_assert(!cuda_for_dali::std::is_copy_constructible<Tup>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Tup&>::value, "");
    }
    // args constructors
    {
        static_assert(cuda_for_dali::std::is_constructible<Tup, Elem&&>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Elem const&>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Elem&>::value, "");
    }
    // cuda_for_dali::std::allocator not supported
    /*
    ...
    {
        static_assert(cuda_for_dali::std::is_constructible<Tup, Tag, Alloc>::value, "");
        static_assert(cuda_for_dali::std::is_constructible<Tup, Tag, Alloc, Tup&&>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Tag, Alloc, Tup const&>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Tag, Alloc, Tup &>::value, "");
    }
    // uses-allocator args constructors
    {
        static_assert(cuda_for_dali::std::is_constructible<Tup, Tag, Alloc, Elem&&>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Tag, Alloc, Elem const&>::value, "");
        static_assert(!cuda_for_dali::std::is_constructible<Tup, Tag, Alloc, Elem &>::value, "");
    }
    */
}
...
int main(int, char**)
{
    ...
    {
        typedef cuda_for_dali::std::tuple<MoveOnly, MoveOnly> T;
    ...
    {
        typedef cuda_for_dali::std::tuple<MoveOnly, MoveOnly, MoveOnly> T;
    ...
    // (w/ __tuple_leaf)
    {
        typedef cuda_for_dali::std::tuple<ConstructsWithTupleLeaf> d_t;
