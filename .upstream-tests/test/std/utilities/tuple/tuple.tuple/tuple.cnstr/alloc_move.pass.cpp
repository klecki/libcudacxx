...
{
    {
        ...
        T t0;
        T t(cuda_for_dali::std::allocator_arg, A1<int>(), cuda_for_dali::std::move(t0));
    }
    {
    ...
    }
    {
        ...
        T t(cuda_for_dali::std::allocator_arg, A1<int>(5), cuda_for_dali::std::move(t0));
...
// testing extensions
    ...
    {
        typedef cuda_for_dali::std::tuple<MoveOnly, alloc_first, alloc_last> T;
        T t0(1, 2, 3);
        alloc_first::allocator_constructed() = false;
        alloc_last::allocator_constructed() = false;
        T t(cuda_for_dali::std::allocator_arg, A1<int>(5), cuda_for_dali::std::move(t0));
