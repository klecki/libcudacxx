...
int main(int, char**)
{
    ...
    /*
    {
        ...
        static_assert(cuda_for_dali::std::is_move_assignable<T>::value, "");
    ...
    */
    ...
    }
    {
        ...
        CountAssign::reset();
        using T = cuda_for_dali::std::tuple<CountAssign, CopyAssignable>;
        static_assert(cuda_for_dali::std::is_move_assignable<T>::value, "");
        T t1;
        T t2;
        t1 = cuda_for_dali::std::move(t2);
        assert(copied == 1);
        assert(moved == 0);
    }
