...
cuda_for_dali::std::tuple<int> __host__ __device__ const tup4() { return cuda_for_dali::std::make_tuple(4); }
...
int main(int, char**)
{
    ...
    {
        cref(cuda_for_dali::std::get<0>(tup4()));  // expected-error {{call to deleted function 'cref'}}
    }
