...
int main(int, char**)
{
    // cuda_for_dali::std::array not supported
    /*
    test<cuda_for_dali::std::array<int, 5>, 5, int, 0>();
    test<cuda_for_dali::std::array<int, 5>, 5, int, 1>();
    test<cuda_for_dali::std::array<const char *, 4>, 4, const char *, 3>();
    test<cuda_for_dali::std::array<volatile int, 4>, 4, volatile int, 3>();
    test<cuda_for_dali::std::array<char *, 3>, 3, char *, 1>();
    test<cuda_for_dali::std::array<char *, 3>, 3, char *, 2>();
    */
