...
void test_is_union()
{
    ...
    static_assert( cuda_for_dali::std::is_union<const T>::value, "");
    static_assert( cuda_for_dali::std::is_union<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_union<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_union_v<T>, "");
    static_assert( cuda_for_dali::std::is_union_v<const T>, "");
    static_assert( cuda_for_dali::std::is_union_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_union_v<const volatile T>, "");
#endif
}
...
int main(int, char**)
{
    ...
    test_is_not_union<cuda_for_dali::std::nullptr_t>();
