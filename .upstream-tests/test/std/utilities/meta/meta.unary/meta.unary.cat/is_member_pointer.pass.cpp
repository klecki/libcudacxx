...
void test_is_member_pointer()
{
    ...
    static_assert( cuda_for_dali::std::is_member_pointer<const T>::value, "");
    static_assert( cuda_for_dali::std::is_member_pointer<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_member_pointer<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_member_pointer_v<T>, "");
    static_assert( cuda_for_dali::std::is_member_pointer_v<const T>, "");
    static_assert( cuda_for_dali::std::is_member_pointer_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_member_pointer_v<const volatile T>, "");
#endif
}
...
int main(int, char**)
{
    ...
    test_is_not_member_pointer<cuda_for_dali::std::nullptr_t>();
