...
void test_is_enum()
{
    ...
    static_assert( cuda_for_dali::std::is_enum<const T>::value, "");
    static_assert( cuda_for_dali::std::is_enum<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_enum<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_enum_v<T>, "");
    static_assert( cuda_for_dali::std::is_enum_v<const T>, "");
    static_assert( cuda_for_dali::std::is_enum_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_enum_v<const volatile T>, "");
#endif
}
...
int main(int, char**)
{
    ...
    test_is_not_enum<cuda_for_dali::std::nullptr_t>();
