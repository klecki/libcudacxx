...
void test_is_integral()
{
    ...
    static_assert( cuda_for_dali::std::is_integral<const T>::value, "");
    static_assert( cuda_for_dali::std::is_integral<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_integral<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_integral_v<T>, "");
    static_assert( cuda_for_dali::std::is_integral_v<const T>, "");
    static_assert( cuda_for_dali::std::is_integral_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_integral_v<const volatile T>, "");
#endif
}
...
int main(int, char**)
{
    ...
    test_is_not_integral<cuda_for_dali::std::nullptr_t>();
