...
void test_is_array()
{
    ...
    static_assert( cuda_for_dali::std::is_array<const T>::value, "");
    static_assert( cuda_for_dali::std::is_array<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_array<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_array_v<T>, "");
    static_assert( cuda_for_dali::std::is_array_v<const T>, "");
    static_assert( cuda_for_dali::std::is_array_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_array_v<const volatile T>, "");
#endif
}
...
int main(int, char**)
{
    ...
    test_is_not_array<cuda_for_dali::std::nullptr_t>();
