...
void test_is_arithmetic()
{
    ...
    static_assert( cuda_for_dali::std::is_arithmetic<const T>::value, "");
    static_assert( cuda_for_dali::std::is_arithmetic<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_arithmetic<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_arithmetic_v<T>, "");
    static_assert( cuda_for_dali::std::is_arithmetic_v<const T>, "");
    static_assert( cuda_for_dali::std::is_arithmetic_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_arithmetic_v<const volatile T>, "");
#endif
}
...
int main(int, char**)
{
    ...
    test_is_not_arithmetic<cuda_for_dali::std::nullptr_t>();
