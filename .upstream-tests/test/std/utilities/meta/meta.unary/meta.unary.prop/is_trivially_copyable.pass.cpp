...
{
    static_assert( cuda_for_dali::std::is_trivially_copyable<T>::value, "");
    static_assert( cuda_for_dali::std::is_trivially_copyable<const T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_trivially_copyable_v<T>, "");
    static_assert( cuda_for_dali::std::is_trivially_copyable_v<const T>, "");
#endif
}
