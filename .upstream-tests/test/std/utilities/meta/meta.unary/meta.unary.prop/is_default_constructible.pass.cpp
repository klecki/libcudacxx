...
{
    static_assert( cuda_for_dali::std::is_default_constructible<T>::value, "");
    static_assert( cuda_for_dali::std::is_default_constructible<const T>::value, "");
    static_assert( cuda_for_dali::std::is_default_constructible<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_default_constructible<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_default_constructible_v<T>, "");
    static_assert( cuda_for_dali::std::is_default_constructible_v<const T>, "");
    static_assert( cuda_for_dali::std::is_default_constructible_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_default_constructible_v<const volatile T>, "");
#endif
}
