...
{
    static_assert( cuda_for_dali::std::is_trivially_destructible<T>::value, "");
    static_assert( cuda_for_dali::std::is_trivially_destructible<const T>::value, "");
    static_assert( cuda_for_dali::std::is_trivially_destructible<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_trivially_destructible<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_trivially_destructible_v<T>, "");
    static_assert( cuda_for_dali::std::is_trivially_destructible_v<const T>, "");
    static_assert( cuda_for_dali::std::is_trivially_destructible_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_trivially_destructible_v<const volatile T>, "");
#endif
}
