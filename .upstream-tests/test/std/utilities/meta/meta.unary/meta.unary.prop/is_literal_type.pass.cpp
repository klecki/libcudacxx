...
{
    static_assert( cuda_for_dali::std::is_literal_type<T>::value, "");
    static_assert( cuda_for_dali::std::is_literal_type<const T>::value, "");
    static_assert( cuda_for_dali::std::is_literal_type<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_literal_type<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_literal_type_v<T>, "");
    static_assert( cuda_for_dali::std::is_literal_type_v<const T>, "");
    static_assert( cuda_for_dali::std::is_literal_type_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_literal_type_v<const volatile T>, "");
#endif
}
...
{
#if TEST_STD_VER >= 11
    test_is_literal_type<cuda_for_dali::std::nullptr_t>();
#endif
