...
{
    static_assert( cuda_for_dali::std::is_trivially_copy_constructible<T>::value, "");
    static_assert( cuda_for_dali::std::is_trivially_copy_constructible<const T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_trivially_copy_constructible_v<T>, "");
    static_assert( cuda_for_dali::std::is_trivially_copy_constructible_v<const T>, "");
#endif
}
