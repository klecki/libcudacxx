...
void test_is_empty()
{
    static_assert( cuda_for_dali::std::is_empty<T>::value, "");
    static_assert( cuda_for_dali::std::is_empty<const T>::value, "");
    static_assert( cuda_for_dali::std::is_empty<volatile T>::value, "");
    static_assert( cuda_for_dali::std::is_empty<const volatile T>::value, "");
#if TEST_STD_VER > 11
    static_assert( cuda_for_dali::std::is_empty_v<T>, "");
    static_assert( cuda_for_dali::std::is_empty_v<const T>, "");
    static_assert( cuda_for_dali::std::is_empty_v<volatile T>, "");
    static_assert( cuda_for_dali::std::is_empty_v<const volatile T>, "");
#endif
}
