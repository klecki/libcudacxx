...
{
    static_assert(( cuda_for_dali::std::is_nothrow_constructible<T>::value), "");
#if TEST_STD_VER > 11
    static_assert(( cuda_for_dali::std::is_nothrow_constructible_v<T>), "");
#endif
}
...
void test_is_nothrow_constructible()
{
    static_assert(( cuda_for_dali::std::is_nothrow_constructible<T, A0>::value), "");
#if TEST_STD_VER > 11
    static_assert(( cuda_for_dali::std::is_nothrow_constructible_v<T, A0>), "");
#endif
}
...
void test_is_not_nothrow_constructible()
{
    static_assert((!cuda_for_dali::std::is_nothrow_constructible<T, A0, A1>::value), "");
#if TEST_STD_VER > 11
    static_assert((!cuda_for_dali::std::is_nothrow_constructible_v<T, A0, A1>), "");
#endif
}
...
int main(int, char**)
{
    ...
    static_assert(!cuda_for_dali::std::is_constructible<Tuple&, Empty>::value, "");
