...
{
    ASSERT_SAME_TYPE(U, typename cuda_for_dali::std::add_pointer<T>::type);
#if TEST_STD_VER > 11
    ASSERT_SAME_TYPE(U, cuda_for_dali::std::add_pointer_t<T>);
#endif
}
...
void test_function0()
{
    ASSERT_SAME_TYPE(F*, typename cuda_for_dali::std::add_pointer<F>::type);
#if TEST_STD_VER > 11
    ASSERT_SAME_TYPE(F*, cuda_for_dali::std::add_pointer_t<F>);
#endif
}
