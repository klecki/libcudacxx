...
{
    ASSERT_SAME_TYPE(U, typename cuda_for_dali::std::add_lvalue_reference<T>::type);
#if TEST_STD_VER > 11
    ASSERT_SAME_TYPE(U, cuda_for_dali::std::add_lvalue_reference_t<T>);
#endif
}
...
void test_function0()
{
    ASSERT_SAME_TYPE(F&, typename cuda_for_dali::std::add_lvalue_reference<F>::type);
#if TEST_STD_VER > 11
    ASSERT_SAME_TYPE(F&, cuda_for_dali::std::add_lvalue_reference_t<F>);
#endif
}
