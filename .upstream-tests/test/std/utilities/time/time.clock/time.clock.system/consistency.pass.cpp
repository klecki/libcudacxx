...
int main(int, char**)
{
    ...
    static_assert((cuda_for_dali::std::is_same<C::rep, C::duration::rep>::value), "");
    static_assert((cuda_for_dali::std::is_same<C::period, C::duration::period>::value), "");
    static_assert((cuda_for_dali::std::is_same<C::duration, C::time_point::duration>::value), "");
    static_assert((cuda_for_dali::std::is_same<C::time_point::clock, C>::value), "");
    static_assert((C::is_steady || !C::is_steady), "");
    test(+cuda_for_dali::std::chrono::system_clock::is_steady);
