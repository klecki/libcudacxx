...
int main(int, char**)
{
    typedef cuda_for_dali::std::chrono::system_clock Clock1;
    ...
    typedef cuda_for_dali::std::chrono::time_point<Clock1, Duration1> T1;
    typedef cuda_for_dali::std::chrono::time_point<Clock2, Duration2> T2;
