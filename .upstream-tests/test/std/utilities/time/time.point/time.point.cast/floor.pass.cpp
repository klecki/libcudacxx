...
test(const FromDuration& df, const ToDuration& d)
{
    ...
    assert(cuda_for_dali::std::chrono::floor<ToDuration>(f) == t);
    }
}
...
void test_constexpr ()
{
    ...
    static_assert(cuda_for_dali::std::chrono::floor<ToDuration>(f) == t, "");
    }
}
...
//  9000000ms is 2 hours and 30 minutes
    ...
    test_constexpr<cuda_for_dali::std::chrono::milliseconds,-9000000, cuda_for_dali::std::chrono::hours,   -3> ();
    test_constexpr<cuda_for_dali::std::chrono::milliseconds, 9000001, cuda_for_dali::std::chrono::minutes, 150> ();
    test_constexpr<cuda_for_dali::std::chrono::milliseconds,-9000001, cuda_for_dali::std::chrono::minutes,-151> ();
