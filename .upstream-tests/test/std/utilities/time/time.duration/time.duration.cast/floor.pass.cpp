...
{
    {
    typedef decltype(cuda_for_dali::std::chrono::floor<ToDuration>(f)) R;
    static_assert((cuda_for_dali::std::is_same<R, ToDuration>::value), "");
    assert(cuda_for_dali::std::chrono::floor<ToDuration>(f) == d);
    }
}
...
//  9000000ms is 2 hours and 30 minutes
    constexpr cuda_for_dali::std::chrono::hours h1 = cuda_for_dali::std::chrono::floor<cuda_for_dali::std::chrono::hours>(cuda_for_dali::std::chrono::milliseconds(9000000));
    static_assert(h1.count() == 2, "");
    constexpr cuda_for_dali::std::chrono::hours h2 = cuda_for_dali::std::chrono::floor<cuda_for_dali::std::chrono::hours>(cuda_for_dali::std::chrono::milliseconds(-9000000));
