...
int main(int, char**)
{
    ...
    cuda_for_dali::std::chrono::nanoseconds ns2(5);
    assert(ns1 / ns2 == 3);
    }
    {
    ...
    {
    cuda_for_dali::std::chrono::duration<int, cuda_for_dali::std::ratio<2, 3> > s1(30);
    ...
    constexpr cuda_for_dali::std::chrono::nanoseconds ns2(5);
    ...
    {
    constexpr cuda_for_dali::std::chrono::duration<int, cuda_for_dali::std::ratio<2, 3> > s1(30);
