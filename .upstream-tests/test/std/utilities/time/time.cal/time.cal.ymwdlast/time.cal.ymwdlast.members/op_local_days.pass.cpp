...
int main(int, char**)
{
    ...
    ASSERT_NOEXCEPT(                      static_cast<local_days>(cuda_for_dali::std::declval<const year_month_day_last>()));
    ASSERT_SAME_TYPE(local_days, decltype(static_cast<local_days>(cuda_for_dali::std::declval<const year_month_day_last>())));

    { // Last day in Jan 1970 was the 31st
    constexpr year_month_day_last ymdl{year{1970}, month_day_last{cuda_for_dali::std::chrono::January}};
    ...
    {
    constexpr year_month_day_last ymdl{year{2000}, month_day_last{cuda_for_dali::std::chrono::January}};
    constexpr local_days sd{ymdl};
    ...
    {
    constexpr year_month_day_last ymdl{year{1940}, month_day_last{cuda_for_dali::std::chrono::January}};
    constexpr local_days sd{ymdl};
    ...
    {
    year_month_day_last ymdl{year{1939}, month_day_last{cuda_for_dali::std::chrono::November}};
    local_days sd{ymdl};
