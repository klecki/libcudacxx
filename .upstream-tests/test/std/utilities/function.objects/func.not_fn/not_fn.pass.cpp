...
{
    {
        ...
        T value(true);
        using RetT = decltype(cuda_for_dali::std::not_fn(cuda_for_dali::std::move(value)));
        static_assert(cuda_for_dali::std::is_move_constructible<RetT>::value, "");
        static_assert(!cuda_for_dali::std::is_copy_constructible<RetT>::value, "");
        static_assert(!cuda_for_dali::std::is_move_assignable<RetT>::value, "");
        static_assert(!cuda_for_dali::std::is_copy_assignable<RetT>::value, "");
        auto ret = cuda_for_dali::std::not_fn(cuda_for_dali::std::move(value));
        ...
        // original value.
        auto ret2 = cuda_for_dali::std::move(ret);
        assert(ret() == true);
        assert(ret2() == false);
    ...
    }
    {
        ...
        T value(false);
        using RetT = decltype(cuda_for_dali::std::not_fn(value));
        static_assert(cuda_for_dali::std::is_move_constructible<RetT>::value, "");
        static_assert(cuda_for_dali::std::is_copy_constructible<RetT>::value, "");
        static_assert(!cuda_for_dali::std::is_move_assignable<RetT>::value, "");
        static_assert(!cuda_for_dali::std::is_copy_assignable<RetT>::value, "");
    ...
    }
    {
        ...
        static_assert(cuda_for_dali::std::is_move_constructible<RetT>::value, "");
        static_assert(cuda_for_dali::std::is_copy_constructible<RetT>::value, "");
        LIBCPP_STATIC_ASSERT(cuda_for_dali::std::is_move_assignable<RetT>::value, "");
        LIBCPP_STATIC_ASSERT(cuda_for_dali::std::is_copy_assignable<RetT>::value, "");
        auto ret = cuda_for_dali::std::not_fn(value);
        assert(ret() == false);
...
void return_type_tests()
{
    ...
    {
        using T = CopyCallable<bool>;
        auto ret = cuda_for_dali::std::not_fn(T{false});
    ...
    }
    {
        ...
        auto ret = cuda_for_dali::std::not_fn(T{true});
        static_assert(is_same<decltype(ret()), bool>::value, "");
        // static_assert(is_same<decltype(ret(cuda_for_dali::std::string("abc"))), bool>::value, "");
        assert(ret() == false);
    }
    {
...
void other_callable_types_test()
{
    { // test with function pointer
        auto ret = cuda_for_dali::std::not_fn(returns_true);
        assert(ret() == false);
    }
    { // test with lambda
        auto returns_value = [](bool value) { return value; };
        auto ret = cuda_for_dali::std::not_fn(returns_value);
    ...
    { // test with pointer to member function
        ...
        auto ret = cuda_for_dali::std::not_fn(&MemFunCallable::return_value);
        assert(ret(mt) == false);
        assert(ret(mf) == true);
        assert(ret(&mt) == false);
        assert(ret(&mf) == true);
    ...
    { // test with pointer to member function
        ...
        auto ret = cuda_for_dali::std::not_fn(&MemFunCallable::return_value_nc);
        assert(ret(mt) == false);
        assert(ret(mf) == true);
        assert(ret(&mt) == false);
        assert(ret(&mf) == true);
    ...
    { // test with pointer to member data
        MemFunCallable mt(true);
        const MemFunCallable mf(false);
        auto ret = cuda_for_dali::std::not_fn(&MemFunCallable::value);
        assert(ret(mt) == false);
        assert(ret(mf) == true);
        assert(ret(&mt) == false);
        assert(ret(&mf) == true);
...
void throws_in_constructor_test()
{
    ...
    };
    {
        ThrowsOnCopy cp;
        try {
            (void)cuda_for_dali::std::not_fn(cp);
            assert(false);
...
void call_operator_sfinae_test() {
    { // wrong number of arguments
        using T = decltype(cuda_for_dali::std::not_fn(returns_true));
        static_assert(cuda_for_dali::std::is_invocable<T>::value, ""); // callable only with no args
        static_assert(!cuda_for_dali::std::is_invocable<T, bool>::value, "");
    }
    { // violates const correctness (member function pointer)
        using T = decltype(cuda_for_dali::std::not_fn(&MemFunCallable::return_value_nc));
        static_assert(cuda_for_dali::std::is_invocable<T, MemFunCallable&>::value, "");
        static_assert(!cuda_for_dali::std::is_invocable<T, const MemFunCallable&>::value, "");
    }
    { // violates const correctness (call object)
        using Obj = CopyCallable<bool>;
        using NCT = decltype(cuda_for_dali::std::not_fn(Obj{true}));
        using CT = const NCT;
        static_assert(cuda_for_dali::std::is_invocable<NCT>::value, "");
        static_assert(!cuda_for_dali::std::is_invocable<CT>::value, "");
    }
    ...
    { // returns bad type with no operator!
        ...
        using T = decltype(cuda_for_dali::std::not_fn(fn));
        static_assert(cuda_for_dali::std::is_invocable<T, bool>::value, "");
        // static_assert(!cuda_for_dali::std::is_invocable<T, cuda_for_dali::std::string>::value, "");
    }
#endif
}
...
void call_operator_forwarding_test()
{
    ...
    auto obj = cuda_for_dali::std::not_fn(Fn{});
    const auto& c_obj = obj;
    { // test zero args
        obj();
        assert(Fn::check_call<>(CT_NonConst | CT_LValue));
        cuda_for_dali::std::move(obj)();
        assert(Fn::check_call<>(CT_NonConst | CT_RValue));
        c_obj();
        assert(Fn::check_call<>(CT_Const | CT_LValue));
        cuda_for_dali::std::move(c_obj)();
    ...
    { // test value categories
        ...
        obj(cuda_for_dali::std::move(x));
        assert(Fn::check_call<int&&>(CT_NonConst | CT_LValue));
        obj(cuda_for_dali::std::move(cx));
        assert(Fn::check_call<const int&&>(CT_NonConst | CT_LValue));
        obj(42);
        assert(Fn::check_call<int&&>(CT_NonConst | CT_LValue));
    }
    { // test value categories - rvalue
        int x = 42;
        const int cx = 42;
        cuda_for_dali::std::move(obj)(x);
        assert(Fn::check_call<int&>(CT_NonConst | CT_RValue));
        cuda_for_dali::std::move(obj)(cx);
        assert(Fn::check_call<const int&>(CT_NonConst | CT_RValue));
        cuda_for_dali::std::move(obj)(cuda_for_dali::std::move(x));
        assert(Fn::check_call<int&&>(CT_NonConst | CT_RValue));
        cuda_for_dali::std::move(obj)(cuda_for_dali::std::move(cx));
        assert(Fn::check_call<const int&&>(CT_NonConst | CT_RValue));
        cuda_for_dali::std::move(obj)(42);
        assert(Fn::check_call<int&&>(CT_NonConst | CT_RValue));
    }
    { // test value categories - const call
        ...
        c_obj(cuda_for_dali::std::move(x));
        assert(Fn::check_call<int&&>(CT_Const | CT_LValue));
        c_obj(cuda_for_dali::std::move(cx));
        assert(Fn::check_call<const int&&>(CT_Const | CT_LValue));
        c_obj(42);
        assert(Fn::check_call<int&&>(CT_Const | CT_LValue));
    }
    { // test value categories - const call rvalue
        int x = 42;
        const int cx = 42;
        cuda_for_dali::std::move(c_obj)(x);
        assert(Fn::check_call<int&>(CT_Const | CT_RValue));
        cuda_for_dali::std::move(c_obj)(cx);
        assert(Fn::check_call<const int&>(CT_Const | CT_RValue));
        cuda_for_dali::std::move(c_obj)(cuda_for_dali::std::move(x));
        assert(Fn::check_call<int&&>(CT_Const | CT_RValue));
        cuda_for_dali::std::move(c_obj)(cuda_for_dali::std::move(cx));
        assert(Fn::check_call<const int&&>(CT_Const | CT_RValue));
        cuda_for_dali::std::move(c_obj)(42);
        assert(Fn::check_call<int&&>(CT_Const | CT_RValue));
    }
    { // test multi arg
        const double y = 3.14;
        // cuda_for_dali::std::string s = "abc";
        // obj(42, cuda_for_dali::std::move(y), s, cuda_for_dali::std::string{"foo"});
        // Fn::check_call<int&&, const double&&, cuda_for_dali::std::string&, cuda_for_dali::std::string&&>(CT_NonConst | CT_LValue);
        // cuda_for_dali::std::move(obj)(42, cuda_for_dali::std::move(y), s, cuda_for_dali::std::string{"foo"});
        // Fn::check_call<int&&, const double&&, cuda_for_dali::std::string&, cuda_for_dali::std::string&&>(CT_NonConst | CT_RValue);
        // c_obj(42, cuda_for_dali::std::move(y), s, cuda_for_dali::std::string{"foo"});
        // Fn::check_call<int&&, const double&&, cuda_for_dali::std::string&, cuda_for_dali::std::string&&>(CT_Const  | CT_LValue);
        // cuda_for_dali::std::move(c_obj)(42, cuda_for_dali::std::move(y), s, cuda_for_dali::std::string{"foo"});
        // Fn::check_call<int&&, const double&&, cuda_for_dali::std::string&, cuda_for_dali::std::string&&>(CT_Const  | CT_RValue);
    }
}
#endif
...
void test_lwg2767() {
    ...
    struct F { __host__ __device__ bool operator()(Abstract&&) { return false; } };
    {
        Derived d;
        Abstract &a = d;
        bool b = cuda_for_dali::std::not_fn(F{})(cuda_for_dali::std::move(a));
        assert(b);
    }
}
