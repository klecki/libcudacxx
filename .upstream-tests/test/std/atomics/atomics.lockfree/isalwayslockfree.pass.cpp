...
#if __has_attribute(vector_size) && defined(_LIBCUDAFORDALICXX_VERSION) && !defined(__CUDACC__)
...
#endif // __has_attribute(vector_size) && defined(_LIBCUDAFORDALICXX_VERSION)
