...
int main(int, char**)
{
    ...
    test<cuda_for_dali::std::atomic_ref<int*>, int*, local_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_system>, int*, local_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_device>, int*, local_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_block>, int*, local_memory_selector>();
#endif
#ifdef __CUDA_ARCH__
    test<cuda_for_dali::std::atomic_ref<int*>, int*, shared_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_system>, int*, shared_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_device>, int*, shared_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_block>, int*, shared_memory_selector>();

    test<cuda_for_dali::std::atomic_ref<int*>, int*, global_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_system>, int*, global_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_device>, int*, global_memory_selector>();
    test<cuda_for_dali::atomic_ref<int*, cuda_for_dali::thread_scope_block>, int*, global_memory_selector>();
#endif
  return 0;
}
