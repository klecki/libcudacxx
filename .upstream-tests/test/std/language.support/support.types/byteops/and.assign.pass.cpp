...
int main(int, char**) {
    ...
    static_assert(cuda_for_dali::std::to_integer<int>(test(b1, b8)) == 0, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b1, b9)) == 1, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b8, b9)) == 8, "");

    static_assert(cuda_for_dali::std::to_integer<int>(test(b8, b1)) == 0, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b9, b1)) == 1, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b9, b8)) == 8, "");
