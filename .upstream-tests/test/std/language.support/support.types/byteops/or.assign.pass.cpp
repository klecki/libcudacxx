...
int main(int, char**) {
    ...
    static_assert(cuda_for_dali::std::to_integer<int>(test(b1, b2)) ==  3, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b1, b8)) ==  9, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b2, b8)) == 10, "");

    static_assert(cuda_for_dali::std::to_integer<int>(test(b2, b1)) ==  3, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b8, b1)) ==  9, "");
    static_assert(cuda_for_dali::std::to_integer<int>(test(b8, b2)) == 10, "");
