...
__host__ __device__ void test_edges()
{
    ...
    {
        cuda_for_dali::std::complex<double> r = cosh(testcases[i]);
        ...
        {
            assert(cuda_for_dali::std::isinf(r.real()));
            assert(cuda_for_dali::std::signbit(r.real()) == cuda_for_dali::std::signbit(cos(testcases[i].imag())));
            assert(cuda_for_dali::std::isinf(r.imag()));
            assert(cuda_for_dali::std::signbit(r.imag()) == cuda_for_dali::std::signbit(testcases[i].real() * sin(testcases[i].imag())));
        }
