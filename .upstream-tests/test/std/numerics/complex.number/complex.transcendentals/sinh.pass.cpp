...
__host__ __device__ void test_edges()
{
    ...
    {
        cuda_for_dali::std::complex<double> r = sinh(testcases[i]);
        ...
        else if (testcases[i].real() == 0 && cuda_for_dali::std::isinf(testcases[i].imag()))
        {
            assert(r.real() == 0);
        ...
        else if (cuda_for_dali::std::isinf(testcases[i].real()) && testcases[i].imag() == 0)
        {
        ...
        {
            assert(cuda_for_dali::std::isinf(r.real()));
            assert(cuda_for_dali::std::signbit(r.real()) == cuda_for_dali::std::signbit(testcases[i].real() * cos(testcases[i].imag())));
            assert(cuda_for_dali::std::isinf(r.imag()));
            assert(cuda_for_dali::std::signbit(r.imag()) == cuda_for_dali::std::signbit(sin(testcases[i].imag())));
        }
