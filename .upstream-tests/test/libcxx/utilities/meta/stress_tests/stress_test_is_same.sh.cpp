...
// -------------------------------------------
// cuda_for_dali::std::_IsSame:    689.634 ms     356 K
// cuda_for_dali::std::is_same:  8,129.180 ms     560 K
//
...
#ifdef TEST_NEW
#define IS_SAME  cuda_for_dali::std::_IsSame
#else
#define IS_SAME cuda_for_dali::std::is_same
#endif
